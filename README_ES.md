...
- Se **descarga la última "`box.phar`"** des de la [página de lanzamiento de familia de cabeza](https://github.com/humbug/box/releases). (En https://github.com/humbug/box/releases)
